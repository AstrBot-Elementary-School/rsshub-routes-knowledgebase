...
```json
{
  ...
  "topFeeds": [
    ...
    {
      "description": "Langmuir - Powered by RSSHub",
      "errorAt": "2025-12-13T14:14:10.428Z",
      ...
      "id": "222669747039060031",
      "image": null,
      "ownerUserId": null,
      "siteUrl": "https://pubs.acs.org/toc/langd5/0/0",
      "title": "Langmuir",
      "type": "feed",
      "url": "rsshub://acs/journal/langd5"
    }
  ]
}
```
