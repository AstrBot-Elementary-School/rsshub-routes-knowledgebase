...
```json
{
  ...
  "topFeeds": [
    ...
    },
    {
      ...
      "errorMessage": "[GET] \"https://install.appcenter.ms/api/v0.1/apps/adirh3-gmail.com/fluent-search-alpha/distribution_groups/exe/releases/1196?is_install_page=true\": 410 Gone\n",
