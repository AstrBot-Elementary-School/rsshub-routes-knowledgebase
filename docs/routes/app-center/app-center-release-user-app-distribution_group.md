...
```json
{
  ...
  "topFeeds": [
    ...
    },
    {
      ...
      "errorMessage": "[GET] \"https://install.appcenter.ms/api/v0.1/apps/adirh3-gmail.com/fluent-search-alpha/distribution_groups/exe/public_releases?scope=tester\": 403 Forbidden\n",
