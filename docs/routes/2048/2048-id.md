...
```json
{
  ...
  "topFeeds": [
    ...
    },
    {
      ...
      "errorAt": "2026-09-03T01:19:15.591Z",
      "errorMessage": "Failed to fetch\nAuthentication failed. Access denied.\n/2048/135\n[GET] \"https://2048.info/undefined\": <no response> fetch failed (getaddrinfo ENOTFOUND dh.rkkpl.cn)\n[GET] \"https://2048.info/undefined\": <no response> fetch failed (getaddrinfo EAI_AGAIN dh.rkkpl.cn)\n[GET] \"https://2048.info/undefined\": <no response> fetch failed (Client network socket disconnected before secure TLS connection was established)\n[GET] \"https://2048.info/undefined\": <no response> fetch failed (getaddrinfo ENOTFOUND dh.rkkpl.cn)\n530 \nAuthentication failed. Access denied.\n/2048/135\nFailed to fetch\n",
      "id": "67569763372478464",
      "image": null,
      "ownerUserId": null,
      "siteUrl": "https://5dbms.0a4qgk7-n.shop/thread.php?fid-135.html",
      "title": "原創达人 - 2048核基地",
      "type": "feed",
      "url": "rsshub://2048/135"
    }
