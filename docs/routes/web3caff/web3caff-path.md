  ...
  "topFeeds": [
    {
      ...
      "errorMessage": "[GET] \"https://web3caff.com\": <no response> fetch failed (C022A7DD727F0000:error:0A000410:SSL routines:ssl3_read_bytes:ssl/tls alert handshake failure:../deps/openssl/openssl/ssl/record/rec_layer_s3.c:918:SSL alert number 40\n)\n",
