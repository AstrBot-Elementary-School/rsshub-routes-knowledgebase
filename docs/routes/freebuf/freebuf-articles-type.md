  ...
  "topFeeds": [
    {
      ...
      "errorAt": "2026-08-19T13:04:13.612Z",
      "errorMessage": "[GET] \"https://www.freebuf.com/fapi/frontend/category/list?name=web&page=1&limit=20&select=0&order=0&type=category\": <no response> fetch failed\n[GET] \"https://www.freebuf.com/fapi/frontend/category/list?name=web&page=1&limit=20&select=0&order=0&type=category\": 405 Method Not Allowed\n",
